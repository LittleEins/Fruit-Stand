...
#window.iconbitmap(os.path.join(directory, "src","app.ico")) # windowdow icon
print("printing"+os.path.join(directory, "src","app.ico"))
#Constants
bg_default = '#d87644'
bg_btn = '#be4a2f'
bg_light = '#e4a672'
bg_grass = '#5fc14c'
bg_error = '#e43b44'
no_img = Image.open(os.path.join(directory, img_dir,"error.png"))
...
def home():
        ...
        npc_img = Image.open(os.path.join(directory, img_dir,"npc.png"))
        npc_img2 = Image.open(os.path.join(directory, img_dir,"npc2.png"))
        border_img = Image.open(os.path.join(directory, img_dir,"border.png"))
...
def display_csv(dictreader):
    ...
    item_img = Image.open(os.path.join(directory, img_dir,"0.png"))
    item_res = item_img.resize((100,100))
...
def fruit():
    ...
    with open(os.path.join(directory, "src","fruits.csv"), 'r') as file:
        dictreader = csv.DictReader(file,delimiter=';')
        display_csv(dictreader)
    #back_button
    global back
    back_img = Image.open(os.path.join(directory, img_dir,"back.png"))
...
def vegetable():
    ...
    menu_frame = Frame(main_frame,bg='#be4a2f',width=800, height=500)
    menu_frame.pack(pady=50,padx=50)
    with open(os.path.join(directory, "src","vegetable.csv"), 'r') as file:
        dictreader = csv.DictReader(file,delimiter=';')
        display_csv(dictreader)
    #back_button
    global back
...
def foods():
    ...
    menu_frame = Frame(main_frame,bg='#be4a2f',width=800, height=500)
    menu_frame.pack(pady=50,padx=50)
    with open(os.path.join(directory, "src","foods.csv"), 'r') as file:
        dictreader = csv.DictReader(file,delimiter=';')
        display_csv(dictreader)
    #back_button
    global back
...
def menu():
    ...
    #Images
    stand1 = Image.open(os.path.join(directory, img_dir,"stand1.png"))
    stand2 = Image.open(os.path.join(directory, img_dir,"stand2.png"))
    stand3 = Image.open(os.path.join(directory, img_dir,"stand3.png"))
    home_img = Image.open(os.path.join(directory, img_dir,"home.png"))
    ...
    home_btn.config(command=quit_btn)
